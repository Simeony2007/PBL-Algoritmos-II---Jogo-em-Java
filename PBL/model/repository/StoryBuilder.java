...
public class StoryBuilder {
    ...
    public static Chapter BuildChapter1(Chapter chapter){
        ...
        scene1.addOption("Jurei protegê-la até o fim dos meus dias, e nem mesmo a morte tem o direito de quebrar nosso laço.", "scene2", 0, 5, 0, 0, 0);
        scene1.addOption("Ficar na terra sem Eurídice é uma sentença pior que o próprio Tártaro. Eu não tenho nada mais a perder.", "scene2", 0, 0, 0, 5, 0);
        scene1.addOption("A tirania das Moiras não vai roubar minha esposa. Eu vou descer ao reino de Hades e tomar o que é meu de volta.", "scene2", 0, 0, 0, 0, 5);
        ...
        scene2.addOption("Uma melodia suave e envolvente que evoca o repouso da natureza, abrandando a ferocidade da besta até fazê-la adormecer.", null, 0, 1, 0, 0, 0);
        scene2.addOption("Um canto lúgubre sobre a dor da perda, conectando-se com a própria essência sombria do Submundo e fazendo o guardião lamentar em vez de atacar.", null, 0, 0, 0, 1, 0);
        scene2.addOption("Acordes retumbantes e agressivos que simulam o rugido da guerra, impondo respeito e subjugando o cão pela força e imponência do som.", null, 0, 0, 1, 0, 0);
